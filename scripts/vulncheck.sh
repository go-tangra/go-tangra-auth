...
#   back to http.DefaultServeMux. Mitigated in transport/http.NewServer, which always
#   installs explicit 404/405 handlers; asserted by tests/contract TestHTTPServerNeverServesDefaultMux.
